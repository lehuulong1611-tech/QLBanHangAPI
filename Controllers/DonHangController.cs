...
namespace QLBanHangAPI.Controllers
{
    ...
    public class DonHangController : ControllerBase
    {
        ...
        // Các cấu trúc DTO nhận dữ liệu sửa đổi từ Frontend
        ...
        // =========================================================================
        // 🌟 GET: api/DonHang/TrongNgay?maNV=NV001 (LẤY ĐƠN + CHI TIẾT SẢN PHẨM)
        // =========================================================================
        [HttpGet("TrongNgay")]
        public async Task<IActionResult> GetDonHangTrongNgay([FromQuery] string maNV)
        {
            ...
            try
            {
                ...
                var listDonHang = new List<object>();
                    ...
                    using (var readerDH = await cmdDH.ExecuteReaderAsync())
                    {
                        while (await readerDH.ReadAsync())
                        {
                            listDonHang.Add(new
                            {
                                ...
                                // Sẽ được bơm dữ liệu chi tiết ở bước sau
                                danhSachSanPham = new List<object>()
                            });
                        }
                    }
                }
                ...
                foreach (dynamic dh in listDonHang)
                {
                    ...
                    finalResult.Add(new
                    {
                        ...
                        dh.trangThai,
                        danhSachSanPham = listChiTiet // <--- Đã có dữ liệu chi tiết!
                    });
                }
        ...
        // =========================================================================
        // 🌟 4. GET: api/DonHang/ThongKeDashboard?maNV=NV001 (ĐÃ SỬA LỖI THIẾU CHỮ AND)
        // =========================================================================
        ...
        // =========================================================================
        // 🌟 5. POST: api/DonHang (Hàm Thêm đơn hàng gốc - Giữ nguyên gốc của bạn)
        // =========================================================================
        [HttpPost]
        public async Task<IActionResult> TaoDonHang([FromBody] DonHangInsertModel model)
        {
            ...
            using (var transaction = await _context.Database.BeginTransactionAsync())
            {
                try
                {
                    ...
                    await transaction.CommitAsync();
                    return Ok(new { maDonHangChinhThuc = maDonHangChinhThuc });
                }
                catch (Exception ex)
                {
                    await transaction.RollbackAsync();
